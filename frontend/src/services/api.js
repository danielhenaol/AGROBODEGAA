...
export const api = {
  ...
  createClassification: (token, productId, data) => createApiClient(token).post(`/api/v1/products/${productId}/classifications`, data),
  getClassifications: (token, productId) => createApiClient(token).get(`/api/v1/products/${productId}/classifications`),
  deleteClassification: (token, productId, classId) => createApiClient(token).delete(`/api/v1/products/${productId}/classifications/${classId}`),
